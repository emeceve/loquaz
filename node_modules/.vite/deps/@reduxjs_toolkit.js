...
function createReducer(initialState, mapOrBuilderCallback, actionMatchers, defaultCaseReducer) {
  ...
  if (isStateFunction(initialState)) {
    getInitialState = function() {
      return immer_esm_default(initialState(), function() {
      });
    };
  } else {
    var frozenInitialState_1 = immer_esm_default(initialState, function() {
    });
    getInitialState = function() {
...
function createSlice(options) {
  ...
  var initialState = typeof options.initialState == "function" ? options.initialState : immer_esm_default(options.initialState, function() {
  });
